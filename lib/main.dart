...
//android
// one step not mention in the package :
// is to add ic_notification.xml in path android/main/res/drawable-v21
...
class _MeetingState extends State<Meeting> {
  ...
  final roomText = TextEditingController(text: "test-room-test");
  ...
  final userEmailText = TextEditingController(text: "test@email.com");
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: const Text('My Test')),
        body: Container(
